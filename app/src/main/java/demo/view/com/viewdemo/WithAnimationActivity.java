...
import demo.view.com.viewdemo.view.NewIncomeRingView;
import demo.view.com.viewdemo.view.viewbean.RingBean;

public class WithAnimationActivity extends Activity {
    private NewIncomeRingView newIncomeRingView;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.test_withanimtion);
        newIncomeRingView=findViewById(R.id.newIncomeRingView);
        test1();
    }
    private void test1() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            newIncomeRingView.setData(list);
    }
}
